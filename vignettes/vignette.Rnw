...
$\alpha_{0}$ 
% TODO: check: \textbf{(fixme: $\alpha_{1}$ or $\alpha_{0}$?)}
...
% TODO: use LaTeX package "varioref" for better wording of the page reference
%       when it happens to be on the same page
